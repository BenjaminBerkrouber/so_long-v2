...
/*   Updated: 2023/11/22 13:00:52 by bberkrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**
** @param  left_str   The string from which the line is extracted.
...
/*
** Creates a new string after the newline character found in 'left_str',
** effectively removing the extracted line from the original string.
**
** @param  left_str   The original string containing the extracted line.
